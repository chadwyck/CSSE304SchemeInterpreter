    ...
    (case prim-proc
      ...
      [(sub1) (if (= (length args) 1) 
                ...
                (error 'apply-prim-proc 
                  ...
                  (length args)))]
      [(cons) (apply-k k (apply-and-check-args cons args 2 =))]
      [(=) (apply-k k (apply-and-check-args = args 1 >=))]
      [(/) (apply-k k (apply-and-check-args / args 1 >=))]
      [(zero?) (apply-k k (apply-and-check-args zero? args 1 =))]
      [(not) (apply-k k (apply-and-check-args not args 1 =))]
      [(<) (apply-k k (apply-and-check-args < args 1 >=))]
      [(<=) (apply-k k (apply-and-check-args <= args 1 >=))]
      [(>) (apply-k k (apply-and-check-args > args 1 >=))]
      [(>=) (apply-k k (apply-and-check-args >= args 1 >=))]
      [(car) (apply-k k (apply-and-check-args car args 1 =))]
      [(cdr) (apply-k k (apply-and-check-args cdr args 1 =))]
      [(list) args]
      [(null?) (apply-k k (apply-and-check-args null? args 1 =))]
      [(assq) (apply-k k (apply-and-check-args assq args 2 =))]
      [(eq?) (apply-k k (apply-and-check-args eq? args 2 =))]
      [(equal?) (apply-k k (apply-and-check-args equal? args 2 =))]
      [(eqv?) (apply-k k (apply-and-check-args eqv? args 2 =))]
      [(atom?) (apply-k k (apply-and-check-args atom? args 1 =))]
      [(length) (apply-k k (apply-and-check-args length args 1 =))]
      ...
      [(vector-ref) (apply-k k (apply-and-check-args vector-ref args 2 =))]
      [(vector?) (apply-k k (apply-and-check-args vector? args 1 =))]
      [(number?) (apply-k k (apply-and-check-args number? args 1 =))]
      [(symbol?) (apply-k k (apply-and-check-args symbol? args 1 =))]
